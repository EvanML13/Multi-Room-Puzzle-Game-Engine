...
# =============================================================================
# Game Engine Lifecycle - Low Level Wrappings
# =============================================================================
...
# =====================================================================================================
# Game Engine Operations - Low Level Wrappings
# =====================================================================================================
...
lib.game_engine_get_room_ids.argtypes = [GameEngine, ctypes.POINTER(ctypes.c_char_p), ctypes.POINTER(ctypes.c_int)]
lib.game_engine_get_room_ids.restype = Status

lib.game_engine_reset.argtypes = [GameEngine]
lib.game_engine_reset.restype = Status

lib.game_engine_get_adjacency_matrix.argtypes = [GameEngine, ctypes.POINTER(ctypes.POINTER(ctypes.c_int)), ctypes.POINTER(ctypes.POINTER(ctypes.c_int)), ctypes.POINTER(ctypes.c_int)]
lib.game_engine_get_adjacency_matrix.restype = Status

lib.game_engine_get_total_treasures.argtypes = [GameEngine]
lib.game_engine_get_total_treasures.restype = ctypes.c_int

lib.game_engine_get_room_uncollected_treasures.argtypes = [GameEngine, ctypes.c_int]
lib.game_engine_get_room_uncollected_treasures.restype = ctypes.c_int

lib.game_engine_get_room_dimensions_by_id.argtypes = [GameEngine, ctypes.c_int, ctypes.POINTER(ctypes.c_int), ctypes.POINTER(ctypes.c_int)]
lib.game_engine_get_room_dimensions_by_id.restype = Status

# =============================================================================================
# Player Operations - Low Level Wrappings
# =============================================================================================
...
# ============================================================
# Memory Management - Low Level Wrappings
# ============================================================
